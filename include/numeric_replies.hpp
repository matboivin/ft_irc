...
/*   Updated: 2021/11/06 16:37:59 by mboivin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft_irc
{
	...
	void	rpl_whoisserver(Message& msg, const std::string& description); // 312
	...
	void	err_needmoreparams(Message& msg, const std::string& error_string = "Not enough parameters"); // 461
