...
/*   Updated: 2021/12/13 13:41:28 by mboivin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft_irc
{
	...
	void	rpl_umodeis(Message& msg, const Client& client, bool rewrite = false); // 221
	...
	void	err_cannotsendtochan(Message& msg, const std::string& chan_name, bool rewrite = false); // 404
